...
35 stdlib unittest cases over the resolver, validate, render, staleness, archive and
doctor paths. Runs in about 3 seconds, so there is no reason to push around it.
